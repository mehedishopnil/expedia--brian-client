...
import { FaChevronLeft, FaChevronRight, FaCheck, FaWifi, FaLock, FaShieldAlt } from 'react-icons/fa';
...
const Checkout = () => {
    ...
    if (!paymentData) {
        return (
            <div className="max-w-4xl mx-auto p-4 text-center">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">No payment information found</h1>
                <p className="text-gray-600 mb-6">Please complete your reservation process from the payment page</p>
                <Link 
                    to="/" 
    ...
    const { baseAmount, fees, isDeposit, refundableDate, tax, totalAmount, type: paymentType } = paymentDetails;
    const { img, img2, img3, location: resortLocation, place_name, room_details, reviews_amount } = resort;
    ...
    const ratingText = rating >= 9 ? 'Wonderful' : rating >= 8 ? 'Excellent' : 'Very Good';
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-4 md:p-6">
                            ...
                            <div className="flex items-center mt-2">
                                ...
                                <span className="text-gray-500 text-sm ml-2">({reviews_amount} reviews)</span>
                            </div>
                            ...
                            <div className="space-y-2">
                                <p className="font-medium">${privacy_room_amount} • {type}</p>
                                <p className="text-gray-600">{bed} • Sleeps {sleeps}</p>
                            ...
                            <div className="flex items-start">
                                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded-md text-xs font-bold mr-3">VIP</span>
                                <p className="text-gray-700 flex-1">Expect outstanding service at this top-rated VIP Access stay.</p>
                            </div>
                            ...
                            >
                                <p className="font-medium">Special/Accessibility requests (optional)</p>
                                <FaChevronRight className={`transition-transform ${showSpecialRequests ? 'rotate-90' : ''}`} />
                            </div>
                            ...
                            <div className="flex items-start mt-4 bg-blue-50 p-3 rounded-lg">
                                ...
                                <p className="text-gray-700">You have good taste! Book now before someone else grabs it!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Guest Info Card */}
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
                        <h2 className="text-xl font-bold text-gray-800 mb-4">Who's checking in?</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Last name (required)</label>
                                <input type="text" className="input input-bordered w-full" required />
                            </div>
                            <div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Mobile phone number (required)</label>
                                <input type="tel" className="input input-bordered w-full" required />
                            </div>
                            <div className="flex items-start">
                                <input type="checkbox" id="text-alerts" className="checkbox checkbox-sm mt-1 mr-2" />
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Debit/Credit card number*</label>
                                <input type="text" className="input input-bordered w-full" required />
                            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
                        ...
                        <ul className="space-y-3 text-sm text-gray-700 mb-4">
                            ...
                            <li className="list-disc ml-4">
                                The name on the reservation must match the name on the guest's photo identification provided at check-in.
                            </li>
                            <li className="list-disc ml-4">
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg mb-4">
                            ...
                            <p className="font-medium">Resort fee: USD 40.67 per accommodation, per night</p>
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg mb-6">
                            <p className="text-sm text-gray-700">
                                ...
                                <Link to="#" className="text-blue-600 hover:underline"> Privacy Statement</Link>, 
                                <Link to="#" className="text-blue-600 hover:underline"> Government Travel Advice</Link>, and have reviewed and accept the 
                                <Link to="#" className="text-blue-600 hover:underline"> Rules & Restrictions</Link> and 
                                <Link to="#" className="text-blue-600 hover:underline"> Terms of Use</Link>.
                            </p>
                        </div>
                        ...
                        <div className="flex items-start mt-4">
                            ...
                            <p className="text-xs text-gray-500">
                                We use secure transmission and encrypted storage to protect your personal information. Payments are processed in the U.S. except where the travel provider (hotel / airline etc) processes your payment outside the U.S., in which case your card issuer may charge a foreign transaction fee.
                            </p>
                        </div>
                    </div>
                </div>
